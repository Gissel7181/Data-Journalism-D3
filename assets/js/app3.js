...
// Axes Labels - Add g - tag for x axis text (css class)
...
// x-axis - Build xText details (css class)
xText.append("text")
    .attr("y", -19)
...
// y-axis - Add another g tag for yText (css class)
...
// Data Viz - Define dynamic circle radius
var cRadius;
...
// Read in data as promise and newer d3.js method
              ...
              if (self.classed("inactive")) {
                ...
                if (axis === "x") {
                 ...
                 // Update for Y axis selection 
                  ...
                  // Classes change to active and the clicked label
                  labelUpdate(axis, self);
                }
              }
          });
